...
try:
    from orchestrator.theme_schema import validate_theme_config, ThemeConfigError
except ImportError:
...
class OpenDataWorkflow:
    ...
    def run_metrics(self, theme: str):
        ...
        cfg = self._load_theme_cfg(theme)
        try:
            from engines.metrics_engine import run_metrics as _run_metrics
        except ImportError:
    ...
    def run_normalize_schema(self, theme: str):
        ...
        try:
            from orchestrator.normalize_schema import backfill_license_status, normalize_and_persist_facilities
        except ImportError:
    ...
    def run_snapshot(self, theme: str, force: bool = False):
        ...
        cfg = self._load_theme_cfg(theme)
        try:
            from engines.snapshot_engine import capture_snapshot
        except ImportError:
