...
export const RANK_CONFIG = {
  S: { label: '90~100点', color: '#22f10f', bg: '#fef9e7', border: '#f39c12' },
  A: { label: '80~89点', color: '#ccbf2e', bg: '#e8f8f5', border: '#27ae60' },
  B: { label: '70~79点', color: '#3498db', bg: '#ebf5fb', border: '#2980b9' },
  C: { label: '~69点', color: '#e94c4c', bg: '#f2f4f4', border: '#7f8c8d' },
};
