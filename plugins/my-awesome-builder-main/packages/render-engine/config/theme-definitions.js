...
// ─────────────────────────────────────────────────────────────────────────────
const SHARED_ANIMATION_PRESETS = {
    none: {
        duration: '0ms',
        microDuration: '0ms',
        easing: 'linear',
...
// FUTURE-PURPLE THEME
// ─────────────────────────────────────────────────────────────────────────────
export const futurePurpleTheme = {
    id: 'future-purple',
    ...
    backgrounds: {
        'gradient-grid': {
            backgroundImage: 'linear-gradient(135deg, #0f0a1e 0%, #1a0a2e 50%, #0a0a1e 100%), ' +
        ...
        pattern: {
            backgroundImage: 'radial-gradient(circle, rgba(192,132,252,0.15) 1px, transparent 1px)',
...
export const alexandrosTheme = {
    ...
    backgrounds: {
        'gradient-grid': {
            backgroundImage: "linear-gradient(to bottom right, #fef9f0, #fff3e0), " +
        ...
        pattern: {
            backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Crect x='5' y='5' width='12' height='12' fill='%23ff9f1c' opacity='0.12' rx='1'/%3E%3Crect x='35' y='35' width='12' height='12' fill='%23ff9f1c' opacity='0.10' rx='1' transform='rotate(45 41 41)'/%3E%3Cpolygon points='43,2 50,15 36,15' fill='%232563eb' opacity='0.10'/%3E%3C/svg%3E\")",
 ...
 */
export function getThemeCssVars(themeId, dark = false) {
 ...
 */
export function themeDataAttr(themeId) {
