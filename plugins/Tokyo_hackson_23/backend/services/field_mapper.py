...
FACILITY_FIELD_CANDIDATES: dict[str, list[str]] = {
    "name": [
        "施設名", "name", "名称", "公園名", "図書館名", "保育園名", 
        "避難所名", "タイトル", "施設名称", "名称（漢字）", "事業所名", "店舗名"
    ],
    "address": [
        "住所", "address", "所在地", "場所", "設置場所", 
        "設置住所", "住所（漢字）", "所在地（漢字）", "位置"
    ],
    "latitude": [
        "緯度", "latitude", "lat", "Y座標", "Ｙ座標", "y", "Y",
        "緯度(世界測地系)", "緯度（世界測地系）", "北緯", "Latitude"
    ],
    "longitude": [
        "経度", "longitude", "lng", "lon", "X座標", "Ｘ座標", "x", "X",
        "経度(世界測地系)", "経度（世界測地系）", "東経", "Longitude"
    ],
}
# ──────────────────────────────────────────────
